...
#
# Реализация получилась крайне не оптимальной.
# Не слишком масштабируемой, с большой вложенностью из-за попыток сделать всечерез циклы, переусложненной, не читаемой.
